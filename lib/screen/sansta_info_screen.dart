...
class SansthInfoScreen extends StatefulWidget {
  const SansthInfoScreen({super.key});

  @override
  State<SansthInfoScreen> createState() => _SansthInfoScreenState();
}

class _SansthInfoScreenState extends State<SansthInfoScreen>with SingleTickerProviderStateMixin {
  late TabController _tabController;

  List<Tab2Model> Images = Tab2Model.Images;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppbar(title: "संस्थेविषयी",),
      drawer: CustomDrawer(),
