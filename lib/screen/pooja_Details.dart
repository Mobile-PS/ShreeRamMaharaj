...
class PoojaDetailsScreen extends StatefulWidget {
  String? name;
   PoojaDetailsScreen({super.key,this.name});

  @override
  State<PoojaDetailsScreen> createState() => _PoojaDetailsScreenState();
}

class _PoojaDetailsScreenState extends State<PoojaDetailsScreen> with SingleTickerProviderStateMixin {
  late TabController _tabController;
  List<PoojaDetailsTabModel> tabs= PoojaDetailsTabModel.Images;
